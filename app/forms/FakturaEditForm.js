...
export default class FakturaEditForm extends Component {
   ...
   componentWillReceiveProps(nextProps) {
      ...
      base.fetch(path, {
         ...
         this.setState({
            ...
            datum1: moment(data.datum1, 'DD.MM.YYYY').toDate(),
            datum2: moment(data.datum2, 'DD.MM.YYYY').toDate(),
            datum3: moment(data.datum3, 'DD.MM.YYYY').toDate(),
            datum4: moment(data.datum4, 'DD.MM.YYYY').toDate(),
   ...
   render() {
      let naslov = 'Izmena fakture broj '+this.state.punBroj;
